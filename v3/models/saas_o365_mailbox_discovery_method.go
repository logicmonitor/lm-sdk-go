...
func (m *SaasO365MailboxDiscoveryMethod) Name() string {
	return "SaasO365MailboxDiscoveryMethod"
}
...
func (m *SaasO365MailboxDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.SaasO365MailboxDiscoveryMethodAllOf1 = data.SaasO365MailboxDiscoveryMethodAllOf1
...
func (m SaasO365MailboxDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		SaasO365MailboxDiscoveryMethodAllOf1: m.SaasO365MailboxDiscoveryMethodAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *SaasO365MailboxDiscoveryMethod) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with SaasO365MailboxDiscoveryMethodAllOf1
...
func (m *SaasO365MailboxDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res SaasO365MailboxDiscoveryMethod
