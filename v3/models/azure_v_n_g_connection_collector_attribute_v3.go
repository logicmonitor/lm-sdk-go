...
func (m *AzureVNGConnectionCollectorAttributeV3) Name() string {
	return "AzureVNGConnectionCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AzureVNGConnectionCollectorAttributeV3) SetName(val string) {
}
...
func (m *AzureVNGConnectionCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVNGConnectionCollectorAttributeV3) validatePeriod(formats strfmt.Registry) error {
...
func (m *AzureVNGConnectionCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVNGConnectionCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AzureVNGConnectionCollectorAttributeV3
