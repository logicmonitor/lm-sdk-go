...
func (m *GcpBillingCollectorAttribute) Name() string {
	return "GcpBillingCollectorAttribute"
}
...
func (m *GcpBillingCollectorAttribute) UnmarshalJSON(raw []byte) error {
	...
	result.GcpBillingCollectorAttributeAllOf1 = data.GcpBillingCollectorAttributeAllOf1
...
func (m GcpBillingCollectorAttribute) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		GcpBillingCollectorAttributeAllOf1: m.GcpBillingCollectorAttributeAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *GcpBillingCollectorAttribute) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with GcpBillingCollectorAttributeAllOf1
...
func (m *GcpBillingCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res GcpBillingCollectorAttribute
