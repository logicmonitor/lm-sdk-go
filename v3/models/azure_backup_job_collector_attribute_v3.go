...
func (m *AzureBackupJobCollectorAttributeV3) Name() string {
	return "AzureBackupJobCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AzureBackupJobCollectorAttributeV3) SetName(val string) {
}
...
func (m *AzureBackupJobCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureBackupJobCollectorAttributeV3) validatePeriod(formats strfmt.Registry) error {
...
func (m *AzureBackupJobCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AzureBackupJobCollectorAttributeV3
