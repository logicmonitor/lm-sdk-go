...
func (m *SaasOffice365SkusCollectorAttribute) Name() string {
	return "SaasOffice365SkusCollectorAttribute"
}

// SetName sets the name of this subtype
func (m *SaasOffice365SkusCollectorAttribute) SetName(val string) {
}
...
func (m *SaasOffice365SkusCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SaasOffice365SkusCollectorAttribute) validatePeriod(formats strfmt.Registry) error {
...
func (m *SaasOffice365SkusCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res SaasOffice365SkusCollectorAttribute
