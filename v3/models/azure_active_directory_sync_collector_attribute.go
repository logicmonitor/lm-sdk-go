...
func (m *AzureActiveDirectorySyncCollectorAttribute) Name() string {
	return "AzureActiveDirectorySyncCollectorAttribute"
}

// SetName sets the name of this subtype
func (m *AzureActiveDirectorySyncCollectorAttribute) SetName(val string) {
}
...
func (m *AzureActiveDirectorySyncCollectorAttribute) UnmarshalJSON(raw []byte) error {
	...
	result.AzureActiveDirectorySyncCollectorAttributeAllOf1 = data.AzureActiveDirectorySyncCollectorAttributeAllOf1
...
func (m AzureActiveDirectorySyncCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
	b1, err = json.Marshal(struct {
		...
		AzureActiveDirectorySyncCollectorAttributeAllOf1: m.AzureActiveDirectorySyncCollectorAttributeAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *AzureActiveDirectorySyncCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with AzureActiveDirectorySyncCollectorAttributeAllOf1
...
func (m *AzureActiveDirectorySyncCollectorAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureActiveDirectorySyncCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AzureActiveDirectorySyncCollectorAttribute
