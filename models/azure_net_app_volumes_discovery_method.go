...
func (m *AzureNetAppVolumesDiscoveryMethod) Name() string {
	return "AzureNetAppVolumesDiscoveryMethod"
}
...
func (m *AzureNetAppVolumesDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.AzureNetAppVolumesDiscoveryMethodAllOf1 = data.AzureNetAppVolumesDiscoveryMethodAllOf1
...
func (m AzureNetAppVolumesDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		AzureNetAppVolumesDiscoveryMethodAllOf1: m.AzureNetAppVolumesDiscoveryMethodAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *AzureNetAppVolumesDiscoveryMethod) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with AzureNetAppVolumesDiscoveryMethodAllOf1
...
func (m *AzureNetAppVolumesDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res AzureNetAppVolumesDiscoveryMethod
