...
func (m *SaasZoomPlanUsageCollectorAttributeV3) Name() string {
	return "SaasZoomPlanUsageCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *SaasZoomPlanUsageCollectorAttributeV3) SetName(val string) {
}
...
func (m *SaasZoomPlanUsageCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SaasZoomPlanUsageCollectorAttributeV3) validatePlanType(formats strfmt.Registry) error {
...
func (m *SaasZoomPlanUsageCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res SaasZoomPlanUsageCollectorAttributeV3
