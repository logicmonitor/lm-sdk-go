...
func (m *AzureReplicationJobCollectorAttributeV3) Name() string {
	return "AzureReplicationJobCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AzureReplicationJobCollectorAttributeV3) SetName(val string) {
}
...
func (m *AzureReplicationJobCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureReplicationJobCollectorAttributeV3) validatePeriod(formats strfmt.Registry) error {
...
func (m *AzureReplicationJobCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureReplicationJobCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AzureReplicationJobCollectorAttributeV3
