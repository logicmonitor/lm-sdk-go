...
func (m *EventSourcePaginationResponse) Items() []EventSource {
	return m.itemsField
}
...
func (m *EventSourcePaginationResponse) UnmarshalJSON(raw []byte) error {
	...
	var propItems []EventSource
	if string(data.Items) != "null" {
		items, err := UnmarshalEventSourceSlice(bytes.NewBuffer(data.Items), runtime.JSONConsumer())
	...
	var result EventSourcePaginationResponse
...
func (m EventSourcePaginationResponse) MarshalJSON() ([]byte, error) {
	...
	b2, err = json.Marshal(struct {
		Items []EventSource `json:"items,omitempty"`
	}{
...
func (m *EventSourcePaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *EventSourcePaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EventSourcePaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EventSourcePaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EventSourcePaginationResponse) UnmarshalBinary(b []byte) error {
	var res EventSourcePaginationResponse
