...
func (m *SaasZoomJSONCollectorAttributeV3) Name() string {
	return "SaasZoomJsonCollectorAttributeV3"
}
...
func (m *SaasZoomJSONCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SaasZoomJSONCollectorAttributeV3) validateEndpointURLSuffix(formats strfmt.Registry) error {
...
func (m *SaasZoomJSONCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res SaasZoomJSONCollectorAttributeV3
