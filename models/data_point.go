...
func (m *DataPoint) contextValidateDataSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataPoint) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
