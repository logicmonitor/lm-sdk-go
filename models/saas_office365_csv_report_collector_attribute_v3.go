...
func (m *SaasOffice365CsvReportCollectorAttributeV3) Name() string {
	return "SaasOffice365CsvReportCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *SaasOffice365CsvReportCollectorAttributeV3) SetName(val string) {
}
...
func (m *SaasOffice365CsvReportCollectorAttributeV3) UnmarshalJSON(raw []byte) error {
	...
	result.ReportName = data.ReportName
...
func (m SaasOffice365CsvReportCollectorAttributeV3) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *SaasOffice365CsvReportCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SaasOffice365CsvReportCollectorAttributeV3) validateReportName(formats strfmt.Registry) error {
...
func (m *SaasOffice365CsvReportCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SaasOffice365CsvReportCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res SaasOffice365CsvReportCollectorAttributeV3
