...
func (m *GcpBillingDiscoveryMethodV3) Name() string {
	return "GcpBillingDiscoveryMethodV3"
}
...
func (m *GcpBillingDiscoveryMethodV3) validateGcpBillingType(formats strfmt.Registry) error {
...
func (m *GcpBillingDiscoveryMethodV3) UnmarshalBinary(b []byte) error {
	var res GcpBillingDiscoveryMethodV3
