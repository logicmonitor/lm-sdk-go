...
func (m *WebsiteGroupSDTHistoryPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupSDTHistoryPaginationResponse) UnmarshalBinary(b []byte) error {
	var res WebsiteGroupSDTHistoryPaginationResponse
