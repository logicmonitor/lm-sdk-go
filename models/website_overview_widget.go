...
func (m *WebsiteOverviewWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *WebsiteOverviewWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *WebsiteOverviewWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *WebsiteOverviewWidget) SetSupportCustomProperty(val bool) {
