...
func (m AwsAutoScalingServiceLimitsCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AwsAutoScalingServiceLimitsCollectorAttribute) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsAutoScalingServiceLimitsCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AwsAutoScalingServiceLimitsCollectorAttribute
