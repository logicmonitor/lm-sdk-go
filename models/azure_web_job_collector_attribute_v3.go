...
func (m *AzureWebJobCollectorAttributeV3) Name() string {
	return "AzureWebJobCollectorAttributeV3"
}
...
func (m *AzureWebJobCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureWebJobCollectorAttributeV3) validatePeriod(formats strfmt.Registry) error {
...
func (m *AzureWebJobCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AzureWebJobCollectorAttributeV3
