...
func (m *EchoEventSource) OriginRegistryID() string {
	return m.originRegistryIdField
}

// SetOriginRegistryID sets the origin registry Id of this subtype
func (m *EchoEventSource) SetOriginRegistryID(val string) {
...
func (m *EchoEventSource) UnmarshalJSON(raw []byte) error {
	...
	result.EchoEventSourceAllOf1 = data.EchoEventSourceAllOf1
...
func (m EchoEventSource) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		EchoEventSourceAllOf1: m.EchoEventSourceAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *EchoEventSource) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with EchoEventSourceAllOf1
...
func (m *EchoEventSource) validateAlertEffectiveIval(formats strfmt.Registry) error {
...
func (m *EchoEventSource) validateEventSource(formats strfmt.Registry) error {
...
func (m *EchoEventSource) validateEventSourceFilters(formats strfmt.Registry) error {
...
func (m *EchoEventSource) validateFilters(formats strfmt.Registry) error {
...
func (m *EchoEventSource) validateInstallationMetadata(formats strfmt.Registry) error {
...
func (m *EchoEventSource) validateName(formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateAuditVersion(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateChecksum(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateEventSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateEventSourceFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateInstallationMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateLineageID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EchoEventSource) contextValidateVersion(ctx context.Context, formats strfmt.Registry) error {
