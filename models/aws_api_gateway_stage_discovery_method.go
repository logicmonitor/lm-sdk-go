...
func (m *AwsAPIGatewayStageDiscoveryMethod) Name() string {
	return "AwsApiGatewayStageDiscoveryMethod"
}
...
func (m *AwsAPIGatewayStageDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.AwsAPIGatewayStageDiscoveryMethodAllOf1 = data.AwsAPIGatewayStageDiscoveryMethodAllOf1
...
func (m AwsAPIGatewayStageDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		AwsAPIGatewayStageDiscoveryMethodAllOf1: m.AwsAPIGatewayStageDiscoveryMethodAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *AwsAPIGatewayStageDiscoveryMethod) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with AwsAPIGatewayStageDiscoveryMethodAllOf1
...
func (m *AwsAPIGatewayStageDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res AwsAPIGatewayStageDiscoveryMethod
