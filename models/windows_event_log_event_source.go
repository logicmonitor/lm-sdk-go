...
func (m *WindowsEventLogEventSource) EventSource() EventSource {
	return m.eventSourceField
}

// SetEventSource sets the event source of this subtype
func (m *WindowsEventLogEventSource) SetEventSource(val EventSource) {
	m.eventSourceField = val
}

// EventSourceFilters gets the event source filters of this subtype
func (m *WindowsEventLogEventSource) EventSourceFilters() []*EventSourceFilter {
	return m.eventSourceFiltersField
}

// SetEventSourceFilters sets the event source filters of this subtype
func (m *WindowsEventLogEventSource) SetEventSourceFilters(val []*EventSourceFilter) {
	m.eventSourceFiltersField = val
}

// Filters gets the filters of this subtype
func (m *WindowsEventLogEventSource) Filters() []*RestEventSourceFilter {
...
func (m *WindowsEventLogEventSource) Group() string {
	return m.groupField
}
...
func (m *WindowsEventLogEventSource) ID() int32 {
	return m.idField
}
...
func (m *WindowsEventLogEventSource) Name() *string {
	return m.nameField
}
...
func (m *WindowsEventLogEventSource) OriginRegistryID() string {
	return m.originRegistryIdField
}

// SetOriginRegistryID sets the origin registry Id of this subtype
func (m *WindowsEventLogEventSource) SetOriginRegistryID(val string) {
...
func (m *WindowsEventLogEventSource) Tags() string {
	return m.tagsField
}
...
func (m *WindowsEventLogEventSource) UnmarshalJSON(raw []byte) error {
	...
	result.WindowsEventLogEventSourceAllOf1 = data.WindowsEventLogEventSourceAllOf1
...
func (m WindowsEventLogEventSource) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		WindowsEventLogEventSourceAllOf1: m.WindowsEventLogEventSourceAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *WindowsEventLogEventSource) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with WindowsEventLogEventSourceAllOf1
...
func (m *WindowsEventLogEventSource) validateAccessGroupIds(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateAccessGroups(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateAlertEffectiveIval(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateEventSource(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateEventSourceFilters(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateFilters(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateInstallationMetadata(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) validateName(formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateAccessGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateAuditVersion(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateChecksum(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateEventSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateEventSourceFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateInstallationMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateLineageID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) contextValidateVersion(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsEventLogEventSource) UnmarshalBinary(b []byte) error {
	var res WindowsEventLogEventSource
