...
func (m *DeviceDataSourceInstanceSDT) DefaultValue() strfmt.DateTime {
	return m.defaultValueField
}

// SetDefaultValue sets the default value of this subtype
func (m *DeviceDataSourceInstanceSDT) SetDefaultValue(val strfmt.DateTime) {
...
func (m *DeviceDataSourceInstanceSDT) validateDefaultValue(formats strfmt.Registry) error {
