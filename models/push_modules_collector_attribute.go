...
func (m *PushModulesCollectorAttribute) Name() string {
	return "PushModulesCollectorAttribute"
}
...
func (m *PushModulesCollectorAttribute) UnmarshalJSON(raw []byte) error {
	...
	result.PushModulesCollectorAttributeAllOf1 = data.PushModulesCollectorAttributeAllOf1
...
func (m PushModulesCollectorAttribute) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		PushModulesCollectorAttributeAllOf1: m.PushModulesCollectorAttributeAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *PushModulesCollectorAttribute) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with PushModulesCollectorAttributeAllOf1
...
func (m *PushModulesCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res PushModulesCollectorAttribute
