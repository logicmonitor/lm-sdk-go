...
func (m *DeviceBatchJobSDT) DefaultValue() strfmt.DateTime {
	return m.defaultValueField
}

// SetDefaultValue sets the default value of this subtype
func (m *DeviceBatchJobSDT) SetDefaultValue(val strfmt.DateTime) {
...
func (m *DeviceBatchJobSDT) validateDefaultValue(formats strfmt.Registry) error {
