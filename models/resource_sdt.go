...
func (m *ResourceSDT) DefaultValue() strfmt.DateTime {
	return m.defaultValueField
}

// SetDefaultValue sets the default value of this subtype
func (m *ResourceSDT) SetDefaultValue(val strfmt.DateTime) {
...
func (m *ResourceSDT) validateDefaultValue(formats strfmt.Registry) error {
...
func (m *ResourceSDT) contextValidateAdmin(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourceSDT) contextValidateEndDateTimeOnLocal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourceSDT) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourceSDT) contextValidateIsEffective(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourceSDT) contextValidateStartDateTimeOnLocal(ctx context.Context, formats strfmt.Registry) error {
