...
func (m *EndpointPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *EndpointPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EndpointPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EndpointPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EndpointPaginationResponse) UnmarshalBinary(b []byte) error {
	var res EndpointPaginationResponse
