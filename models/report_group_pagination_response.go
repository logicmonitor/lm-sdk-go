...
func (m *ReportGroupPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *ReportGroupPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportGroupPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportGroupPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportGroupPaginationResponse) UnmarshalBinary(b []byte) error {
	var res ReportGroupPaginationResponse
