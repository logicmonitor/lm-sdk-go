...
func (m *RestSavedMapWidgetV3) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *RestSavedMapWidgetV3) SetIsSupportCustomProperty(val bool) {
...
func (m *RestSavedMapWidgetV3) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *RestSavedMapWidgetV3) SetSupportCustomProperty(val bool) {
