...
func (m *SaaSZoomPlanUsageDiscoveryMethod) Name() string {
	return "SaaSZoomPlanUsageDiscoveryMethod"
}
...
func (m *SaaSZoomPlanUsageDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.ZoomPlanUsageType = data.ZoomPlanUsageType
...
func (m SaaSZoomPlanUsageDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		ZoomPlanUsageType: m.ZoomPlanUsageType,
	})
	if err != nil {
		return nil, err
	}
...
func (m *SaaSZoomPlanUsageDiscoveryMethod) Validate(formats strfmt.Registry) error {
	var res []error

	if err := m.validateZoomPlanUsageType(formats); err != nil {
		res = append(res, err)
	}
...
func (m *SaaSZoomPlanUsageDiscoveryMethod) validateZoomPlanUsageType(formats strfmt.Registry) error {

	if err := validate.Required("zoomPlanUsageType", "body", m.ZoomPlanUsageType); err != nil {
		return err
	}
...
func (m *SaaSZoomPlanUsageDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res SaaSZoomPlanUsageDiscoveryMethod
