...
type FlowRecordPaginationResponse struct {
	...
	// items
	Items []*NetFlowRecord `json:"items"`
...
func (m *FlowRecordPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *FlowRecordPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowRecordPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowRecordPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowRecordPaginationResponse) UnmarshalBinary(b []byte) error {
	var res FlowRecordPaginationResponse
