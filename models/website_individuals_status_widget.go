...
func (m *WebsiteIndividualsStatusWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *WebsiteIndividualsStatusWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *WebsiteIndividualsStatusWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *WebsiteIndividualsStatusWidget) SetSupportCustomProperty(val bool) {
