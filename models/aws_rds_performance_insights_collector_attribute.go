...
func (m *AwsRdsPerformanceInsightsCollectorAttribute) Name() string {
	return "AwsRdsPerformanceInsightsCollectorAttribute"
}

// SetName sets the name of this subtype
func (m *AwsRdsPerformanceInsightsCollectorAttribute) SetName(val string) {
}
...
func (m AwsRdsPerformanceInsightsCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AwsRdsPerformanceInsightsCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsRdsPerformanceInsightsCollectorAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsRdsPerformanceInsightsCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AwsRdsPerformanceInsightsCollectorAttribute
