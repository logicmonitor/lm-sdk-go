...
func (m *DeviceLogPipeLineResourceSDT) DefaultValue() strfmt.DateTime {
	return m.defaultValueField
}

// SetDefaultValue sets the default value of this subtype
func (m *DeviceLogPipeLineResourceSDT) SetDefaultValue(val strfmt.DateTime) {
...
func (m *DeviceLogPipeLineResourceSDT) validateDefaultValue(formats strfmt.Registry) error {
