...
type IntegrationAuditLogPaginationResponse struct {
	...
	// items
	Items []*IntegrationAuditLog `json:"items"`
}

// Validate validates this integration audit log pagination response
func (m *IntegrationAuditLogPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IntegrationAuditLogPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *IntegrationAuditLogPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntegrationAuditLogPaginationResponse) UnmarshalBinary(b []byte) error {
	var res IntegrationAuditLogPaginationResponse
