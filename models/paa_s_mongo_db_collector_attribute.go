...
func (m *PaaSMongoDbCollectorAttribute) Name() string {
	return "PaaSMongoDbCollectorAttribute"
}
...
func (m *PaaSMongoDbCollectorAttribute) validateResourceURL(formats strfmt.Registry) error {
...
func (m *PaaSMongoDbCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res PaaSMongoDbCollectorAttribute
