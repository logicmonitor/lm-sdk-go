...
type UnmonitoredDevicePaginationResponse struct {
	...
	// items
	Items []*UnmonitoredDevices `json:"items"`
...
func (m *UnmonitoredDevicePaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UnmonitoredDevicePaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *UnmonitoredDevicePaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnmonitoredDevicePaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnmonitoredDevicePaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnmonitoredDevicePaginationResponse) UnmarshalBinary(b []byte) error {
	var res UnmonitoredDevicePaginationResponse
