...
func (m *NetflowGroupGraphWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *NetflowGroupGraphWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *NetflowGroupGraphWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *NetflowGroupGraphWidget) SetSupportCustomProperty(val bool) {
