...
func (m *OverviewGraphWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *OverviewGraphWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *OverviewGraphWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *OverviewGraphWidget) SetSupportCustomProperty(val bool) {
