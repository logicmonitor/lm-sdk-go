...
func (m *RestAzureAdvisorEventSource) EventSource() EventSource {
	return m.eventSourceField
}

// SetEventSource sets the event source of this subtype
func (m *RestAzureAdvisorEventSource) SetEventSource(val EventSource) {
	m.eventSourceField = val
}

// EventSourceFilters gets the event source filters of this subtype
func (m *RestAzureAdvisorEventSource) EventSourceFilters() []*EventSourceFilter {
	return m.eventSourceFiltersField
}

// SetEventSourceFilters sets the event source filters of this subtype
func (m *RestAzureAdvisorEventSource) SetEventSourceFilters(val []*EventSourceFilter) {
...
func (m *RestAzureAdvisorEventSource) OriginRegistryID() string {
	return m.originRegistryIdField
}

// SetOriginRegistryID sets the origin registry Id of this subtype
func (m *RestAzureAdvisorEventSource) SetOriginRegistryID(val string) {
...
func (m *RestAzureAdvisorEventSource) validateAccessGroupIds(formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) validateAccessGroups(formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) validateEventSource(formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) validateEventSourceFilters(formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) contextValidateAccessGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) contextValidateEventSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestAzureAdvisorEventSource) contextValidateEventSourceFilters(ctx context.Context, formats strfmt.Registry) error {
