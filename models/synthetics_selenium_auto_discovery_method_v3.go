...
func (m *SyntheticsSeleniumAutoDiscoveryMethodV3) Name() string {
	return "SyntheticsSeleniumAutoDiscoveryMethodV3"
}

// SetName sets the name of this subtype
func (m *SyntheticsSeleniumAutoDiscoveryMethodV3) SetName(val string) {
}
...
func (m *SyntheticsSeleniumAutoDiscoveryMethodV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SyntheticsSeleniumAutoDiscoveryMethodV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SyntheticsSeleniumAutoDiscoveryMethodV3) UnmarshalBinary(b []byte) error {
	var res SyntheticsSeleniumAutoDiscoveryMethodV3
