...
func (m *WebsiteOverallStatusWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *WebsiteOverallStatusWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *WebsiteOverallStatusWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *WebsiteOverallStatusWidget) SetSupportCustomProperty(val bool) {
