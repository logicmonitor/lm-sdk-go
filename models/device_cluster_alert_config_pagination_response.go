...
func (m *DeviceClusterAlertConfigPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceClusterAlertConfigPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *DeviceClusterAlertConfigPaginationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceClusterAlertConfigPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceClusterAlertConfigPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceClusterAlertConfigPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceClusterAlertConfigPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DeviceClusterAlertConfigPaginationResponse
