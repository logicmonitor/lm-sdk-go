...
func (m *AzureSynapseDiscoveryMethodV3) Name() string {
	return "AzureSynapseDiscoveryMethodV3"
}
...
func (m *AzureSynapseDiscoveryMethodV3) UnmarshalJSON(raw []byte) error {
	...
	result.AzureSynapseType = data.AzureSynapseType
...
func (m AzureSynapseDiscoveryMethodV3) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		AzureSynapseType: m.AzureSynapseType,
	})
	if err != nil {
		return nil, err
	}
...
func (m *AzureSynapseDiscoveryMethodV3) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAzureSynapseType(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AzureSynapseDiscoveryMethodV3) validateAzureSynapseType(formats strfmt.Registry) error {

	if err := validate.Required("azureSynapseType", "body", m.AzureSynapseType); err != nil {
		return err
	}
...
func (m *AzureSynapseDiscoveryMethodV3) UnmarshalBinary(b []byte) error {
	var res AzureSynapseDiscoveryMethodV3
