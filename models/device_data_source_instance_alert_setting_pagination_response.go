...
func (m *DeviceDataSourceInstanceAlertSettingPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceDataSourceInstanceAlertSettingPaginationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceDataSourceInstanceAlertSettingPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceDataSourceInstanceAlertSettingPaginationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DeviceDataSourceInstanceAlertSettingPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DeviceDataSourceInstanceAlertSettingPaginationResponse
