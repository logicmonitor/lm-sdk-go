...
func (m *AzureVMBackupStatusCollectorAttributeV3) Name() string {
	return "AzureVMBackupStatusCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AzureVMBackupStatusCollectorAttributeV3) SetName(val string) {
}
...
func (m *AzureVMBackupStatusCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVMBackupStatusCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVMBackupStatusCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AzureVMBackupStatusCollectorAttributeV3
