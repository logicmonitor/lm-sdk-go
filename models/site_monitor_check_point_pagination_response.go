...
func (m *SiteMonitorCheckPointPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SiteMonitorCheckPointPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *SiteMonitorCheckPointPaginationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SiteMonitorCheckPointPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteMonitorCheckPointPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteMonitorCheckPointPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteMonitorCheckPointPaginationResponse) UnmarshalBinary(b []byte) error {
	var res SiteMonitorCheckPointPaginationResponse
