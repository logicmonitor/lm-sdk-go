...
type PropertyPaginationResponse struct {
	...
	// items
	Items []*EntityProperty `json:"items"`
...
func (m *PropertyPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *PropertyPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PropertyPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PropertyPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PropertyPaginationResponse) UnmarshalBinary(b []byte) error {
	var res PropertyPaginationResponse
