...
func (m *AwsEbsVolumeSnapshotCollectorAttributeV3) Name() string {
	return "AwsEbsVolumeSnapshotCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AwsEbsVolumeSnapshotCollectorAttributeV3) SetName(val string) {
}
...
func (m AwsEbsVolumeSnapshotCollectorAttributeV3) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AwsEbsVolumeSnapshotCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsEbsVolumeSnapshotCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsEbsVolumeSnapshotCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AwsEbsVolumeSnapshotCollectorAttributeV3
