...
func (m *DashboardPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *DashboardPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DashboardPaginationResponse
