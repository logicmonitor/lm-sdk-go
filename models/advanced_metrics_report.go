...
// AdvancedMetricsReport advanced metrics report
//
// swagger:model AdvancedMetricsReport
...
func (m AdvancedMetricsReport) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this advanced metrics report
func (m *AdvancedMetricsReport) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedMetricsReport) validateName(formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) validateRecipients(formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) validateQuery(formats strfmt.Registry) error {
...
// ContextValidate validate this advanced metrics report based on the context it is used
func (m *AdvancedMetricsReport) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedMetricsReport) contextValidateCustomReportTypeID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateCustomReportTypeName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateEnableViewAsOtherUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateLastGenerateOn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateLastGeneratePages(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateLastGenerateSize(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateLastmodifyUserID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateLastmodifyUserName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateRecipients(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateReportLinkNum(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) contextValidateUserPermission(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedMetricsReport) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AdvancedMetricsReport) UnmarshalBinary(b []byte) error {
	var res AdvancedMetricsReport
