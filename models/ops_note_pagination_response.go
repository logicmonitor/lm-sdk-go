...
func (m *OpsNotePaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *OpsNotePaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpsNotePaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpsNotePaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpsNotePaginationResponse) UnmarshalBinary(b []byte) error {
	var res OpsNotePaginationResponse
