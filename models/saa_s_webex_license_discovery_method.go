...
func (m *SaaSWebexLicenseDiscoveryMethod) Name() string {
	return "SaaSWebexLicenseDiscoveryMethod"
}
...
func (m *SaaSWebexLicenseDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.SaaSWebexLicenseDiscoveryMethodAllOf1 = data.SaaSWebexLicenseDiscoveryMethodAllOf1
...
func (m SaaSWebexLicenseDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		SaaSWebexLicenseDiscoveryMethodAllOf1: m.SaaSWebexLicenseDiscoveryMethodAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *SaaSWebexLicenseDiscoveryMethod) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with SaaSWebexLicenseDiscoveryMethodAllOf1
...
func (m *SaaSWebexLicenseDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res SaaSWebexLicenseDiscoveryMethod
