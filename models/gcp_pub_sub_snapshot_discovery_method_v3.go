...
func (m *GcpPubSubSnapshotDiscoveryMethodV3) Name() string {
	return "GcpPubSubSnapshotDiscoveryMethodV3"
}

// SetName sets the name of this subtype
func (m *GcpPubSubSnapshotDiscoveryMethodV3) SetName(val string) {
}
...
func (m *GcpPubSubSnapshotDiscoveryMethodV3) UnmarshalJSON(raw []byte) error {
	...
	result.GcpPubSubSnapshotDiscoveryMethodV3AllOf1 = data.GcpPubSubSnapshotDiscoveryMethodV3AllOf1
...
func (m GcpPubSubSnapshotDiscoveryMethodV3) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		GcpPubSubSnapshotDiscoveryMethodV3AllOf1: m.GcpPubSubSnapshotDiscoveryMethodV3AllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *GcpPubSubSnapshotDiscoveryMethodV3) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with GcpPubSubSnapshotDiscoveryMethodV3AllOf1
...
func (m *GcpPubSubSnapshotDiscoveryMethodV3) UnmarshalBinary(b []byte) error {
	var res GcpPubSubSnapshotDiscoveryMethodV3
