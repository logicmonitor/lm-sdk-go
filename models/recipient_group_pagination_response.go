...
func (m *RecipientGroupPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecipientGroupPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *RecipientGroupPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecipientGroupPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecipientGroupPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecipientGroupPaginationResponse) UnmarshalBinary(b []byte) error {
	var res RecipientGroupPaginationResponse
