...
func (m *AccessLogPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *AccessLogPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccessLogPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccessLogPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccessLogPaginationResponse) UnmarshalBinary(b []byte) error {
	var res AccessLogPaginationResponse
