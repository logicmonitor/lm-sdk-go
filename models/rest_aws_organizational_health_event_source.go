...
func (m *RestAwsOrganizationalHealthEventSource) AccessGroupIds() []int32 {
	return m.accessGroupIdsField
}

// SetAccessGroupIds sets the access group ids of this subtype
func (m *RestAwsOrganizationalHealthEventSource) SetAccessGroupIds(val []int32) {
	m.accessGroupIdsField = val
}

// AccessGroups gets the access groups of this subtype
func (m *RestAwsOrganizationalHealthEventSource) AccessGroups() []*AccessGroup {
	return m.accessGroupsField
}

// SetAccessGroups sets the access groups of this subtype
func (m *RestAwsOrganizationalHealthEventSource) SetAccessGroups(val []*AccessGroup) {
...
func (m *RestAwsOrganizationalHealthEventSource) EventSource() EventSource {
	return m.eventSourceField
}

// SetEventSource sets the event source of this subtype
func (m *RestAwsOrganizationalHealthEventSource) SetEventSource(val EventSource) {
	m.eventSourceField = val
}

// EventSourceFilters gets the event source filters of this subtype
func (m *RestAwsOrganizationalHealthEventSource) EventSourceFilters() []*EventSourceFilter {
	return m.eventSourceFiltersField
}

// SetEventSourceFilters sets the event source filters of this subtype
func (m *RestAwsOrganizationalHealthEventSource) SetEventSourceFilters(val []*EventSourceFilter) {
...
func (m *RestAwsOrganizationalHealthEventSource) OriginRegistryID() string {
	return m.originRegistryIdField
}

// SetOriginRegistryID sets the origin registry Id of this subtype
func (m *RestAwsOrganizationalHealthEventSource) SetOriginRegistryID(val string) {
...
func (m *RestAwsOrganizationalHealthEventSource) validateAccessGroupIds(formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) validateAccessGroups(formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) validateEventSource(formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) validateEventSourceFilters(formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) contextValidateAccessGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) contextValidateEventSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestAwsOrganizationalHealthEventSource) contextValidateEventSourceFilters(ctx context.Context, formats strfmt.Registry) error {
