...
func (m *DeviceInstanceDataPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceInstanceDataPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *DeviceInstanceDataPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceInstanceDataPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceInstanceDataPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceInstanceDataPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DeviceInstanceDataPaginationResponse
