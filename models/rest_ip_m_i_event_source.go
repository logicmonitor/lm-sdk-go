...
func (m *RestIPMIEventSource) Filters() []*RestEventSourceFilter {
...
// CheckInterval gets the check interval of this subtype
...
func (m *RestIPMIEventSource) validateAlertEffectiveIval(formats strfmt.Registry) error {
...
func (m *RestIPMIEventSource) validateFilters(formats strfmt.Registry) error {
...
func (m *RestIPMIEventSource) validateID(formats strfmt.Registry) error {
...
func (m *RestIPMIEventSource) validateName(formats strfmt.Registry) error {
