...
type EscalationChainPaginationResponse struct {
	...
	// items
	Items []*EscalatingChain `json:"items"`
...
func (m *EscalationChainPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EscalationChainPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *EscalationChainPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EscalationChainPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EscalationChainPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EscalationChainPaginationResponse) UnmarshalBinary(b []byte) error {
	var res EscalationChainPaginationResponse
