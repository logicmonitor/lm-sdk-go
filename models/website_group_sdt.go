...
func (m *WebsiteGroupSDT) DefaultValue() strfmt.DateTime {
	return m.defaultValueField
}

// SetDefaultValue sets the default value of this subtype
func (m *WebsiteGroupSDT) SetDefaultValue(val strfmt.DateTime) {
...
func (m *WebsiteGroupSDT) validateDefaultValue(formats strfmt.Registry) error {
