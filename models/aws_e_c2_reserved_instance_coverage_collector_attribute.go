...
func (m AwsEC2ReservedInstanceCoverageCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AwsEC2ReservedInstanceCoverageCollectorAttribute) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsEC2ReservedInstanceCoverageCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AwsEC2ReservedInstanceCoverageCollectorAttribute
