...
func (m *DashboardGroupPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DashboardGroupPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *DashboardGroupPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardGroupPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardGroupPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DashboardGroupPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DashboardGroupPaginationResponse
