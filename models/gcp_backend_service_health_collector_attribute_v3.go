...
func (m *GcpBackendServiceHealthCollectorAttributeV3) Name() string {
	return "GcpBackendServiceHealthCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *GcpBackendServiceHealthCollectorAttributeV3) SetName(val string) {
}
...
func (m GcpBackendServiceHealthCollectorAttributeV3) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *GcpBackendServiceHealthCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GcpBackendServiceHealthCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GcpBackendServiceHealthCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res GcpBackendServiceHealthCollectorAttributeV3
