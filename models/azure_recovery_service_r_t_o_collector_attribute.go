...
func (m *AzureRecoveryServiceRTOCollectorAttribute) Name() string {
	return "AzureRecoveryServiceRTOCollectorAttribute"
}

// SetName sets the name of this subtype
func (m *AzureRecoveryServiceRTOCollectorAttribute) SetName(val string) {
}
...
func (m AzureRecoveryServiceRTOCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AzureRecoveryServiceRTOCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureRecoveryServiceRTOCollectorAttribute) validatePeriod(formats strfmt.Registry) error {
...
func (m *AzureRecoveryServiceRTOCollectorAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureRecoveryServiceRTOCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AzureRecoveryServiceRTOCollectorAttribute
