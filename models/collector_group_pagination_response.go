...
func (m *CollectorGroupPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CollectorGroupPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *CollectorGroupPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CollectorGroupPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CollectorGroupPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CollectorGroupPaginationResponse) UnmarshalBinary(b []byte) error {
	var res CollectorGroupPaginationResponse
