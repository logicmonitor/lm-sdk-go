...
func (m *UptimeWebCheckStep) Auth() Authentication {
	return m.authField
}

// SetAuth sets the auth of this base type
func (m *UptimeWebCheckStep) SetAuth(val Authentication) {
	m.authField = val
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *UptimeWebCheckStep) UnmarshalJSON(raw []byte) error {
	var data struct {
		HTTPBody string `json:"HTTPBody,omitempty"`
...
func (m UptimeWebCheckStep) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *UptimeWebCheckStep) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
