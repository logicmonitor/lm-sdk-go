...
func (m *APITokenPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *APITokenPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APITokenPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APITokenPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APITokenPaginationResponse) UnmarshalBinary(b []byte) error {
	var res APITokenPaginationResponse
