...
func (m *NetflowGroupWidget) IsSupportCustomProperty() bool {
	return m.isSupportCustomPropertyField
}

// SetIsSupportCustomProperty sets the is support custom property of this subtype
func (m *NetflowGroupWidget) SetIsSupportCustomProperty(val bool) {
...
func (m *NetflowGroupWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *NetflowGroupWidget) SetSupportCustomProperty(val bool) {
