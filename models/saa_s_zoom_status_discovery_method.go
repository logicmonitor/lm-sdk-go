...
func (m *SaaSZoomStatusDiscoveryMethod) Name() string {
	return "SaaSZoomStatusDiscoveryMethod"
}
...
func (m *SaaSZoomStatusDiscoveryMethod) UnmarshalJSON(raw []byte) error {
	...
	result.SaaSZoomStatusDiscoveryMethodAllOf1 = data.SaaSZoomStatusDiscoveryMethodAllOf1
...
func (m SaaSZoomStatusDiscoveryMethod) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		SaaSZoomStatusDiscoveryMethodAllOf1: m.SaaSZoomStatusDiscoveryMethodAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *SaaSZoomStatusDiscoveryMethod) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with SaaSZoomStatusDiscoveryMethodAllOf1
...
func (m *SaaSZoomStatusDiscoveryMethod) UnmarshalBinary(b []byte) error {
	var res SaaSZoomStatusDiscoveryMethod
