...
func (m *CustomGraphWidget) SupportCustomProperty() bool {
	return m.supportCustomPropertyField
}

// SetSupportCustomProperty sets the support custom property of this subtype
func (m *CustomGraphWidget) SetSupportCustomProperty(val bool) {
