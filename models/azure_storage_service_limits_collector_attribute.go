...
func (m *AzureStorageServiceLimitsCollectorAttribute) SetName(val string) {
}
...
func (m AzureStorageServiceLimitsCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *AzureStorageServiceLimitsCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureStorageServiceLimitsCollectorAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureStorageServiceLimitsCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AzureStorageServiceLimitsCollectorAttribute
