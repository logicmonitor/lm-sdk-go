...
func (m *AzureActiveDirectoryUsersCollectorAttribute) Name() string {
	return "AzureActiveDirectoryUsersCollectorAttribute"
}

// SetName sets the name of this subtype
func (m *AzureActiveDirectoryUsersCollectorAttribute) SetName(val string) {
}
...
func (m *AzureActiveDirectoryUsersCollectorAttribute) UnmarshalJSON(raw []byte) error {
	...
	result.AzureActiveDirectoryUsersCollectorAttributeAllOf1 = data.AzureActiveDirectoryUsersCollectorAttributeAllOf1
...
func (m AzureActiveDirectoryUsersCollectorAttribute) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
	b1, err = json.Marshal(struct {
		...
		AzureActiveDirectoryUsersCollectorAttributeAllOf1: m.AzureActiveDirectoryUsersCollectorAttributeAllOf1,
	})
	if err != nil {
		return nil, err
	}
...
func (m *AzureActiveDirectoryUsersCollectorAttribute) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with AzureActiveDirectoryUsersCollectorAttributeAllOf1
...
func (m *AzureActiveDirectoryUsersCollectorAttribute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureActiveDirectoryUsersCollectorAttribute) UnmarshalBinary(b []byte) error {
	var res AzureActiveDirectoryUsersCollectorAttribute
