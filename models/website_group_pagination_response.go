...
func (m *WebsiteGroupPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *WebsiteGroupPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebsiteGroupPaginationResponse) UnmarshalBinary(b []byte) error {
	var res WebsiteGroupPaginationResponse
