...
func (m *AwsRdsServiceLimitsCollectorAttributeV3) Name() string {
	return "AwsRdsServiceLimitsCollectorAttributeV3"
}

// SetName sets the name of this subtype
func (m *AwsRdsServiceLimitsCollectorAttributeV3) SetName(val string) {
}
...
func (m *AwsRdsServiceLimitsCollectorAttributeV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsRdsServiceLimitsCollectorAttributeV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsRdsServiceLimitsCollectorAttributeV3) UnmarshalBinary(b []byte) error {
	var res AwsRdsServiceLimitsCollectorAttributeV3
