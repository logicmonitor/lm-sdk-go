...
// UptimeResourceOverviewReport uptime resource overview report
//
// swagger:model UptimeResourceOverviewReport
type UptimeResourceOverviewReport struct {
	...
	// Whether or not Uptimes with 100% availability should be ignored
	Exclude100Availability bool `json:"exclude100Availability,omitempty"`

	// Whether or not SDTs periods should be considered for the Uptime's availability
...
func (m UptimeResourceOverviewReport) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this uptime resource overview report
func (m *UptimeResourceOverviewReport) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UptimeResourceOverviewReport) validateName(formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) validateRecipients(formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) validateItemsType(formats strfmt.Registry) error {
...
// ContextValidate validate this uptime resource overview report based on the context it is used
func (m *UptimeResourceOverviewReport) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UptimeResourceOverviewReport) contextValidateCustomReportTypeID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateCustomReportTypeName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateEnableViewAsOtherUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateLastGenerateOn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateLastGeneratePages(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateLastGenerateSize(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateLastmodifyUserID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateLastmodifyUserName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateRecipients(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateReportLinkNum(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) contextValidateUserPermission(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UptimeResourceOverviewReport) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UptimeResourceOverviewReport) UnmarshalBinary(b []byte) error {
	var res UptimeResourceOverviewReport
