...
type DeviceDatasourcePaginationResponse struct {
	...
	// items
	Items []*DeviceDataSource `json:"items"`
...
func (m *DeviceDatasourcePaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceDatasourcePaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceDatasourcePaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
