...
func (m *DeviceSDTHistoryPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceSDTHistoryPaginationResponse) validateItems(formats strfmt.Registry) error {
...
func (m *DeviceSDTHistoryPaginationResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceSDTHistoryPaginationResponse) contextValidateSearchID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceSDTHistoryPaginationResponse) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceSDTHistoryPaginationResponse) UnmarshalBinary(b []byte) error {
	var res DeviceSDTHistoryPaginationResponse
