...
for the get device instance list operation typically these are written to a http.Request
*/
...
// WithDeviceID adds the deviceID to the get device instance list params
func (o *GetDeviceInstanceListParams) WithDeviceID(deviceID int32) *GetDeviceInstanceListParams {
	o.SetDeviceID(deviceID)
	return o
}

// SetDeviceID adds the deviceId to the get device instance list params
func (o *GetDeviceInstanceListParams) SetDeviceID(deviceID int32) {
	o.DeviceID = deviceID
}
