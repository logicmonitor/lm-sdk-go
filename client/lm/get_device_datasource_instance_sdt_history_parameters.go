...
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithDefaults() *GetDeviceDatasourceInstanceSDTHistoryParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) SetDefaults() {
	var (
	...
	val := GetDeviceDatasourceInstanceSDTHistoryParams{
...
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithUserAgent(userAgent *string) *GetDeviceDatasourceInstanceSDTHistoryParams {
...
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithFields(fields *string) *GetDeviceDatasourceInstanceSDTHistoryParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get device datasource instance SDT history params
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) SetFields(fields *string) {
	o.Fields = fields
}

// WithFilter adds the filter to the get device datasource instance SDT history params
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithFilter(filter *string) *GetDeviceDatasourceInstanceSDTHistoryParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the get device datasource instance SDT history params
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) SetFilter(filter *string) {
	o.Filter = filter
}
...
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithOffset(offset *int32) *GetDeviceDatasourceInstanceSDTHistoryParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) WithSize(size *int32) *GetDeviceDatasourceInstanceSDTHistoryParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the get device datasource instance SDT history params
func (o *GetDeviceDatasourceInstanceSDTHistoryParams) SetSize(size *int32) {
	o.Size = size
}
