...
type GetRoleListJSONReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetRoleListJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetRoleListJSONOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 429:
		result := NewGetRoleListJSONTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewGetRoleListJSONDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetRoleListJSONOK() *GetRoleListJSONOK {
...
func (o *GetRoleListJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetRoleListJSONTooManyRequests() *GetRoleListJSONTooManyRequests {
...
Too Many Requests
*/
type GetRoleListJSONTooManyRequests struct {
...
func NewGetRoleListJSONDefault(code int) *GetRoleListJSONDefault {
	return &GetRoleListJSONDefault{
		_statusCode: code,
	}
}
...
Error
*/
type GetRoleListJSONDefault struct {
	_statusCode int
...
func (o *GetRoleListJSONDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
