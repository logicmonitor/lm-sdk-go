...
// Code gets the status code for the update device group property by name o k response
func (o *UpdateDeviceGroupPropertyByNameOK) Code() int {
	return 200
}

func (o *UpdateDeviceGroupPropertyByNameOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /device/groups/{gid}/properties/{name}][%d] updateDeviceGroupPropertyByNameOK %s", 200, payload)
}
...
// Code gets the status code for the update device group property by name too many requests response
func (o *UpdateDeviceGroupPropertyByNameTooManyRequests) Code() int {
	return 429
}
...
func (o *UpdateDeviceGroupPropertyByNameDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /device/groups/{gid}/properties/{name}][%d] updateDeviceGroupPropertyByName default %s", o._statusCode, payload)
}
