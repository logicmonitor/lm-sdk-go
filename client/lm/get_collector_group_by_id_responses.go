...
// Code gets the status code for the get collector group by Id o k response
func (o *GetCollectorGroupByIDOK) Code() int {
	return 200
}

func (o *GetCollectorGroupByIDOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /setting/collector/groups/{id}][%d] getCollectorGroupByIdOK %s", 200, payload)
}
...
// Code gets the status code for the get collector group by Id too many requests response
func (o *GetCollectorGroupByIDTooManyRequests) Code() int {
	return 429
}
...
func (o *GetCollectorGroupByIDDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /setting/collector/groups/{id}][%d] getCollectorGroupById default %s", o._statusCode, payload)
}
