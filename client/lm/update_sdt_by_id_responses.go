...
// Code gets the status code for the update Sdt by Id o k response
func (o *UpdateSDTByIDOK) Code() int {
	return 200
}

func (o *UpdateSDTByIDOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /sdt/sdts/{id}][%d] updateSdtByIdOK %s", 200, payload)
}
...
// Code gets the status code for the update Sdt by Id too many requests response
func (o *UpdateSDTByIDTooManyRequests) Code() int {
	return 429
}
