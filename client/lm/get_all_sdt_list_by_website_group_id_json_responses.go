...
type GetAllSDTListByWebsiteGroupIDJSONReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetAllSDTListByWebsiteGroupIDJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetAllSDTListByWebsiteGroupIDJSONOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 429:
		result := NewGetAllSDTListByWebsiteGroupIDJSONTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewGetAllSDTListByWebsiteGroupIDJSONDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetAllSDTListByWebsiteGroupIDJSONOK() *GetAllSDTListByWebsiteGroupIDJSONOK {
...
*/
type GetAllSDTListByWebsiteGroupIDJSONOK struct {
	Payload interface{}
}
...
func (o *GetAllSDTListByWebsiteGroupIDJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetAllSDTListByWebsiteGroupIDJSONTooManyRequests() *GetAllSDTListByWebsiteGroupIDJSONTooManyRequests {
...
Too Many Requests
*/
type GetAllSDTListByWebsiteGroupIDJSONTooManyRequests struct {
...
func NewGetAllSDTListByWebsiteGroupIDJSONDefault(code int) *GetAllSDTListByWebsiteGroupIDJSONDefault {
	return &GetAllSDTListByWebsiteGroupIDJSONDefault{
		_statusCode: code,
	}
}
...
Error
*/
type GetAllSDTListByWebsiteGroupIDJSONDefault struct {
	_statusCode int
...
func (o *GetAllSDTListByWebsiteGroupIDJSONDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
