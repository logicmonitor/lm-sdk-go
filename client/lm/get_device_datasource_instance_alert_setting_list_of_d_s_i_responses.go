...
/*GetDeviceDatasourceInstanceAlertSettingListOfDSIOK handles this case with default header values.
...
/*GetDeviceDatasourceInstanceAlertSettingListOfDSIDefault handles this case with default header values.
