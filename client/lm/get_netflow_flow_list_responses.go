...
// Code gets the status code for the get netflow flow list o k response
func (o *GetNetflowFlowListOK) Code() int {
	return 200
}

func (o *GetNetflowFlowListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /device/devices/{id}/flows][%d] getNetflowFlowListOK %s", 200, payload)
}
...
// Code gets the status code for the get netflow flow list too many requests response
func (o *GetNetflowFlowListTooManyRequests) Code() int {
	return 429
}
...
func (o *GetNetflowFlowListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /device/devices/{id}/flows][%d] getNetflowFlowList default %s", o._statusCode, payload)
}
