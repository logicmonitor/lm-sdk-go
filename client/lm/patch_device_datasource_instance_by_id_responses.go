...
// Code gets the status code for the patch device datasource instance by Id o k response
func (o *PatchDeviceDatasourceInstanceByIDOK) Code() int {
	return 200
}

func (o *PatchDeviceDatasourceInstanceByIDOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /device/devices/{deviceId}/devicedatasources/{hdsId}/instances/{id}][%d] patchDeviceDatasourceInstanceByIdOK %s", 200, payload)
}
...
// Code gets the status code for the patch device datasource instance by Id too many requests response
func (o *PatchDeviceDatasourceInstanceByIDTooManyRequests) Code() int {
	return 429
}
...
func (o *PatchDeviceDatasourceInstanceByIDDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /device/devices/{deviceId}/devicedatasources/{hdsId}/instances/{id}][%d] patchDeviceDatasourceInstanceById default %s", o._statusCode, payload)
}
