...
// NewAddDatasourceAuditVersionParams creates a new AddDatasourceAuditVersionParams object,
...
func NewAddDatasourceAuditVersionParams() *AddDatasourceAuditVersionParams {
	return &AddDatasourceAuditVersionParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewAddDatasourceAuditVersionParamsWithTimeout creates a new AddDatasourceAuditVersionParams object
...
// NewAddDatasourceAuditVersionParamsWithContext creates a new AddDatasourceAuditVersionParams object
...
// NewAddDatasourceAuditVersionParamsWithHTTPClient creates a new AddDatasourceAuditVersionParams object
...
func (o *AddDatasourceAuditVersionParams) WithDefaults() *AddDatasourceAuditVersionParams {
	o.SetDefaults()
	return o
}
...
func (o *AddDatasourceAuditVersionParams) SetDefaults() {
	...
	val := AddDatasourceAuditVersionParams{
...
func (o *AddDatasourceAuditVersionParams) WithTimeout(timeout time.Duration) *AddDatasourceAuditVersionParams {
...
func (o *AddDatasourceAuditVersionParams) WithContext(ctx context.Context) *AddDatasourceAuditVersionParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AddDatasourceAuditVersionParams) WithHTTPClient(client *http.Client) *AddDatasourceAuditVersionParams {
...
func (o *AddDatasourceAuditVersionParams) WithUserAgent(userAgent *string) *AddDatasourceAuditVersionParams {
...
func (o *AddDatasourceAuditVersionParams) WithBody(body *models.Audit) *AddDatasourceAuditVersionParams {
	o.SetBody(body)
	return o
}
...
func (o *AddDatasourceAuditVersionParams) WithID(id int32) *AddDatasourceAuditVersionParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the add datasource audit version params
func (o *AddDatasourceAuditVersionParams) SetID(id int32) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *AddDatasourceAuditVersionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
