...
// WithUserAgent adds the userAgent to the patch datasource by Id params
func (o *PatchDatasourceByIDParams) WithUserAgent(userAgent *string) *PatchDatasourceByIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the patch datasource by Id params
func (o *PatchDatasourceByIDParams) SetUserAgent(userAgent *string) {
