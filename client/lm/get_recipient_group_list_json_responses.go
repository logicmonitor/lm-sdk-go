...
type GetRecipientGroupListJSONReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetRecipientGroupListJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetRecipientGroupListJSONOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 429:
		result := NewGetRecipientGroupListJSONTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewGetRecipientGroupListJSONDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetRecipientGroupListJSONOK() *GetRecipientGroupListJSONOK {
...
*/
type GetRecipientGroupListJSONOK struct {
	Payload interface{}
}
...
func (o *GetRecipientGroupListJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetRecipientGroupListJSONTooManyRequests() *GetRecipientGroupListJSONTooManyRequests {
...
Too Many Requests
*/
type GetRecipientGroupListJSONTooManyRequests struct {
...
func NewGetRecipientGroupListJSONDefault(code int) *GetRecipientGroupListJSONDefault {
	return &GetRecipientGroupListJSONDefault{
		_statusCode: code,
	}
}
...
Error
*/
type GetRecipientGroupListJSONDefault struct {
	_statusCode int
...
func (o *GetRecipientGroupListJSONDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
