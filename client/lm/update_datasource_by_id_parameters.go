...
// WithUserAgent adds the userAgent to the update datasource by Id params
func (o *UpdateDatasourceByIDParams) WithUserAgent(userAgent *string) *UpdateDatasourceByIDParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the update datasource by Id params
func (o *UpdateDatasourceByIDParams) SetUserAgent(userAgent *string) {
