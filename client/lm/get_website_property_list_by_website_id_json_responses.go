...
type GetWebsitePropertyListByWebsiteIDJSONReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetWebsitePropertyListByWebsiteIDJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetWebsitePropertyListByWebsiteIDJSONOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 429:
		result := NewGetWebsitePropertyListByWebsiteIDJSONTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewGetWebsitePropertyListByWebsiteIDJSONDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetWebsitePropertyListByWebsiteIDJSONOK() *GetWebsitePropertyListByWebsiteIDJSONOK {
...
*/
type GetWebsitePropertyListByWebsiteIDJSONOK struct {
	Payload interface{}
}
...
func (o *GetWebsitePropertyListByWebsiteIDJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetWebsitePropertyListByWebsiteIDJSONTooManyRequests() *GetWebsitePropertyListByWebsiteIDJSONTooManyRequests {
...
Too Many Requests
*/
type GetWebsitePropertyListByWebsiteIDJSONTooManyRequests struct {
...
func NewGetWebsitePropertyListByWebsiteIDJSONDefault(code int) *GetWebsitePropertyListByWebsiteIDJSONDefault {
	return &GetWebsitePropertyListByWebsiteIDJSONDefault{
		_statusCode: code,
	}
}
...
Error
*/
type GetWebsitePropertyListByWebsiteIDJSONDefault struct {
	_statusCode int
...
func (o *GetWebsitePropertyListByWebsiteIDJSONDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
