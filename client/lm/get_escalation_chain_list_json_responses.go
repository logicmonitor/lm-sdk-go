...
type GetEscalationChainListJSONReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetEscalationChainListJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetEscalationChainListJSONOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 429:
		result := NewGetEscalationChainListJSONTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewGetEscalationChainListJSONDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetEscalationChainListJSONOK() *GetEscalationChainListJSONOK {
...
Successfully retrieved the escalation chain list
*/
type GetEscalationChainListJSONOK struct {
	Payload interface{}
}
...
func (o *GetEscalationChainListJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEscalationChainListJSONTooManyRequests() *GetEscalationChainListJSONTooManyRequests {
...
Too Many Requests
*/
type GetEscalationChainListJSONTooManyRequests struct {
...
func NewGetEscalationChainListJSONDefault(code int) *GetEscalationChainListJSONDefault {
	return &GetEscalationChainListJSONDefault{
		_statusCode: code,
	}
}
...
Error
*/
type GetEscalationChainListJSONDefault struct {
	_statusCode int
...
func (o *GetEscalationChainListJSONDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
