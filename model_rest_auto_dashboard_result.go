...
type RestAutoDashboardResult struct {
	CreatedDashboardGroup *DashboardGroup `json:"createdDashboardGroup,omitempty"`
	CreatedDashboards []DashboardBase `json:"createdDashboards,omitempty"`
