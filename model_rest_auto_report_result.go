...
type RestAutoReportResult struct {
	CreatedReports []ReportBase `json:"createdReports,omitempty"`
	ErrMsg string `json:"errMsg,omitempty"`
	CreatedReportGroup *RestReportGroup `json:"createdReportGroup,omitempty"`
}
