...
type ServiceOverallStatusWidget struct {
	RowSpan int32 `json:"rowSpan,omitempty"`
	LastUpdatedBy string `json:"lastUpdatedBy,omitempty"`
	UserPermission string `json:"userPermission,omitempty"`
	ServiceSelectMode string `json:"serviceSelectMode,omitempty"`
	ColSpan int32 `json:"colSpan,omitempty"`
	Description string `json:"description,omitempty"`
	SelectedServices []ServiceGroupData `json:"selectedServices"`
