...
type RestAutoVisualResult struct {
	AutoDashboardResult *RestAutoDashboardResult `json:"autoDashboardResult,omitempty"`
	AutoReportResult *RestAutoReportResult `json:"autoReportResult,omitempty"`
